...
class QueryMultiPostRequest(BaseModel):
    """
    QueryMultiPostRequest
    """ # noqa: E501
    queries: Optional[List[QueryMultiPostRequestQueriesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "queries": [QueryMultiPostRequestQueriesInner.from_dict(_item) for _item in obj["queries"]] if obj.get("queries") is not None else None
        })
        return _obj
