...
class HpiSearchGet200Response(BaseModel):
    """
    HpiSearchGet200Response
    """ # noqa: E501
    results: Optional[List[HpiSearchGet200ResponseResultsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [HpiSearchGet200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
